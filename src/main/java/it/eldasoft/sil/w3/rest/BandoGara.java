...
@Path("/bandogara")
public class BandoGara {

  static Logger              logger                = Logger.getLogger(BandoGara.class);
  ...
  public Response setBandoGara(String xml, @Context HttpServletRequest request) {
    ...
    try {
      ...
      if (auth == null) {
        ...
        eldasoftSIMAPWSManager.inserisciBandoGara(username, password, xmlDecoded);
