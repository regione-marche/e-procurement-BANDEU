...
@Path("/avvisoperiodicoindicativo")
public class AvvisoPeriodicoIndicativo {

  static Logger              logger                = Logger.getLogger(AvvisoPeriodicoIndicativo.class);
  ...
  public Response setAvvisoPeriodicoIndicativo(String xml, @Context HttpServletRequest request) {
    ...
    try {
      ...
      if (auth == null) {
        ...
        eldasoftSIMAPWSManager.inserisciAvvisoPeriodicoIndicativo(username, password, xmlDecoded);
