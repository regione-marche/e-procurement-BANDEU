...
@Path("/avvisoprofilocommittente")
public class AvvisoProfiloCommittente {

  static Logger              logger                = Logger.getLogger(AvvisoProfiloCommittente.class);
  ...
  public Response setAvvisoProfiloCommittente(String xml, @Context HttpServletRequest request) {
    ...
    try {
      ...
      if (auth == null) {
        ...
        eldasoftSIMAPWSManager.inserisciAvvisoProfiloCommittente(username, password, xmlDecoded);
