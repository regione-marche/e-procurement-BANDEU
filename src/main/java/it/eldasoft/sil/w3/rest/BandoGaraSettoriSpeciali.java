...
@Path("/bandogarasettorispeciali")
public class BandoGaraSettoriSpeciali {

  static Logger              logger                = Logger.getLogger(BandoGaraSettoriSpeciali.class);
  ...
  public Response setBandoGaraSettoriSpeciali(String xml, @Context HttpServletRequest request) {
    ...
    try {
      ...
      if (auth == null) {
        ...
        eldasoftSIMAPWSManager.inserisciBandoGaraSettoriSpeciali(username, password, xmlDecoded);
