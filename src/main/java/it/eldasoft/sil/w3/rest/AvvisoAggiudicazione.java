...
@Path("/avvisoaggiudicazione")
public class AvvisoAggiudicazione {

  static Logger              logger                = Logger.getLogger(AvvisoAggiudicazione.class);
  ...
  public Response setAvvisoAggiudicazione(String xml, @Context HttpServletRequest request) {
    ...
    try {
      ...
      if (auth == null) {
        ...
        eldasoftSIMAPWSManager.inserisciAvvisoAggiudicazione(username, password, xmlDecoded);
