...
@Path("/avvisopreinformazione")
public class AvvisoPreinformazione {

  static Logger              logger                = Logger.getLogger(AvvisoPreinformazione.class);
  ...
  public Response setAvvisoPreinformazione(String xml, @Context HttpServletRequest request) {
    ...
    try {
      ...
      if (auth == null) {
        ...
        eldasoftSIMAPWSManager.inserisciAvvisoPreinformazione(username, password, xmlDecoded);
