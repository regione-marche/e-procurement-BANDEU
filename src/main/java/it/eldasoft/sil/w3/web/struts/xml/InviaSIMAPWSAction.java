...
public class InviaSIMAPWSAction extends ActionBaseNoOpzioni {

  protected static final String       FORWARD_SUCCESS = "inviasimapwssuccess";
  protected static final String       FORWARD_ERROR   = "inviasimapwserror";
  ...
  protected ActionForward runAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      this.gestioneServiziSIMAPManager.submitNotice(syscon, phase, id);
