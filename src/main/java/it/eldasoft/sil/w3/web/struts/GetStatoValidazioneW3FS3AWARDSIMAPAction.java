...
public class GetStatoValidazioneW3FS3AWARDSIMAPAction extends Action {
  ...
  public final ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
    ...
    HashMap<?, ?> infoValidazione = validazioneSIMAPManager.validateW3FS3AWARD(new Long(id), new Long(item), new Long(profilo.getId()));
