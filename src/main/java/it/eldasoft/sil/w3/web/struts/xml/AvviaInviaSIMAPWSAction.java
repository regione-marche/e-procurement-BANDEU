...
public class AvviaInviaSIMAPWSAction extends ActionBaseNoOpzioni {

  protected static final String                                               FORWARD_CONTROLLO = "inviasimapwscontrollo";
  protected static final String                                               FORWARD_SUCCESS   = "inviasimapwsinvia";

  static Logger                                                               logger            = Logger.getLogger(AvviaInviaSIMAPWSAction.class);
  ...
  protected ActionForward runAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
    ...
    if (logger.isDebugEnabled()) logger.debug("AvviaInviaSIMAPWSAction: inizio metodo");
    ...
    if (logger.isDebugEnabled()) logger.debug("AvviaInviaSIMAPWSAction: fine metodo");
