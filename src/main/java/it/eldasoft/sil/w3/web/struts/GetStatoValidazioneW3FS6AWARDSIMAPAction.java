...
public class GetStatoValidazioneW3FS6AWARDSIMAPAction extends Action {
  ...
  public final ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
    ...
    // TODO: sostituire metodo di validazione da FS3 a FS6
    HashMap<?, ?> infoValidazione = validazioneSIMAPManager.validateW3FS6AWARD(new Long(id), new Long(item), new Long(profilo.getId()));
