...
public class GestoreW3FS7 extends AbstractGestoreEntita {
  ...
  public void preInsert(TransactionStatus status, DataColumnContainer datiForm) throws GestoreException {
    ...
    datiForm.setValue("W3ANNEXB.ID", datiForm.getColumn("W3FS7.ID").getValue().getValue());
    ...
    this.gestioneW3FS7_Q(status, datiForm);
  }
  ...
  /**
   * Gestione informazioni sulle modalita' di qualificazione.
   * 
   * @param status
   * @param datiForm
   * @throws GestoreException
   */
  private void gestioneW3FS7_Q(TransactionStatus status, DataColumnContainer datiForm) throws GestoreException {
    AbstractGestoreChiaveNumerica gestoremultiploW3FS7_Q = new DefaultGestoreEntitaChiaveNumerica("W3FS7_Q", "NUM", new String[] { "ID" },
        this.getRequest());
    this.gestisciAggiornamentiRecordSchedaMultipla(status, datiForm, gestoremultiploW3FS7_Q, "W3FS7_Q",
        new DataColumn[] { datiForm.getColumn("W3FS7.ID") }, null);
  }
