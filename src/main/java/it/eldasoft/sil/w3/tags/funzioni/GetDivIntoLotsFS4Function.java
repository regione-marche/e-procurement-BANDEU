...
public class GetDivIntoLotsFS4Function extends AbstractFunzioneTag {

  public GetDivIntoLotsFS4Function() {
  ...
  public String function(PageContext pageContext, Object[] params) throws JspException {
    ...
    if (chiave != null && chiave.length() > 0) {
      ...
      try {
        div_into_lots = (String) sqlManager.getObject("select div_into_lots from w3fs4s2 where id = ?", new Object[] { id });
