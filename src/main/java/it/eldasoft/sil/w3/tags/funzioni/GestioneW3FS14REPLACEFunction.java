...
public class GestioneW3FS14REPLACEFunction extends AbstractFunzioneTag {

  public GestioneW3FS14REPLACEFunction() {
  ...
  public String function(PageContext pageContext, Object[] params) throws JspException {
    ...
    if (!UtilityTags.SCHEDA_MODO_INSERIMENTO.equals(UtilityTags.getParametro(pageContext,
      ...
      String selectW3FS14CORR = "select id, num, type, object, section, "
          ...
          + " time_old, time_new, codein_new, nomein_new "
          + " from w3fs14corr where id = ? and type = 'REP' order by num";
