...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" idMaschera="W3FS1-scheda" schema="W3">
	...
	<gene:redefineInsert name="corpo">
		<c:set var="divIntoLots" value='${gene:callFunction2("it.eldasoft.sil.w3.tags.funzioni.GetDivIntoLotsFS1Function", pageContext, key)}' />
		<gene:formPagine gestisciProtezioni="true">
			<gene:pagina title="Sez. I: Amministrazione aggiudicatrice" idProtezioni="W3FS1_1">
				<jsp:include page="w3fs1-pg-sezione1.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. II: Oggetto (II.1 e II.3)" idProtezioni="W3FS1_2">
				<jsp:include page="w3fs1-pg-sezione2-1.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. II: Oggetto (II.2)" idProtezioni="W3FS1_2_1" visibile="${divIntoLots ne '1'}">
				<jsp:include page="w3fs1-pg-sezione2-2.jsp" />
			</gene:pagina>			
			<gene:pagina title="Sez. II: Oggetto (II.2)" idProtezioni="W3FS1_2_2" visibile="${divIntoLots eq '1'}">
				<jsp:include page="w3fs1-pg-lista-sezione2-2.jsp" />
			</gene:pagina>	
			<gene:pagina title="Sez. III: Informazioni giuridiche, economiche, finanziarie e tecniche" idProtezioni="W3FS1_3">
				<jsp:include page="w3fs1-pg-sezione3.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. IV: Procedura" idProtezioni="W3FS1_4">
				<jsp:include page="w3fs1-pg-sezione4.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. VI: Altre informazioni" idProtezioni="W3FS1_6">
				<jsp:include page="w3fs1-pg-sezione6.jsp" />
			</gene:pagina>
		</gene:formPagine>
	</gene:redefineInsert>
	...
	<gene:redefineInsert name="addToAzioni" >
		<jsp:include page="/WEB-INF/pages/w3/commons/addtoazioni-simap.jsp" >
			<jsp:param name="formulario" value='W3FS1'/>
		</jsp:include>
	</gene:redefineInsert>
