...
<gene:formScheda entita="W3FS1" gestisciProtezioni="true" gestore="it.eldasoft.sil.w3.tags.gestori.submit.GestoreW3FS1" >
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs1.IV")}<br><br></b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs1.IV.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs1.IV.1.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="TYPE_PROCEDURE" />
	
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs1.IV.1.3")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs1.IV.1.6")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="EAUCTION" />
	<gene:campoScheda campo="EAUCTION_INFO" />

	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs1.IV.1.8")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="GPA" />	

	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs1.IV.2")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs1.IV.2.2")}</b></td>
	</gene:campoScheda>	
	<gene:campoScheda campo="DATE_RECEIPT" />	
	<gene:campoScheda campo="TIME_RECEIPT" />	
	
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs1.IV.2.4")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs1.IV.2.5")}</b></td>
	</gene:campoScheda>
	...
	<gene:fnJavaScriptScheda funzione="gestioneFRAMEWORK('#W3FS1_FRAMEWORK#')" elencocampi="W3FS1_FRAMEWORK" esegui="true" />
	<gene:fnJavaScriptScheda funzione="gestioneFR_SEVERAL_OP('#W3FS1_FR_SEVERAL_OP#')" elencocampi="W3FS1_FR_SEVERAL_OP" esegui="true" />
	<gene:fnJavaScriptScheda funzione="gestioneDPS('#W3FS1_DPS#')" elencocampi="W3FS1_DPS" esegui="true" />
	<gene:fnJavaScriptScheda funzione="gestioneEAUCTION('#W3FS1_EAUCTION#')" elencocampi="W3FS1_EAUCTION" esegui="true" />
...
<gene:javaScript>
	...
	$("#W3FS1_TYPE_PROCEDURE option").each(function() {
		var _v = $(this).val();
		if (_v != 2 && _v != 4 && _v != "") {
			$(this).remove();
		}
	...
	function gestioneFRAMEWORK(framework){
		if (framework == '1') {
			$("#rowW3FS1_FR_SEVERAL_OP").show();
			$("#rowW3FS1_FR_JUSTIFICATION").show();
		} else {
			$("#rowW3FS1_FR_SEVERAL_OP").hide();
			$("#rowW3FS1_FR_NB_PARTECIPANTS").hide();
			$("#rowW3FS1_FR_JUSTIFICATION").hide();
			$("#W3FS1_FR_SEVERAL_OP").val("");
			$("#W3FS1_FR_NB_PARTECIPANTS").val("");
			$("#W3FS1_FR_JUSTIFICATION").val("");
		}
	}

	function gestioneFR_SEVERAL_OP(fr_several_op){
		if (fr_several_op == '1') {
			$("#rowW3FS1_FR_NB_PARTECIPANTS").show();
		} else {
			$("#rowW3FS1_FR_NB_PARTECIPANTS").hide();
			$("#W3FS1_FR_NB_PARTECIPANTS").val("");
		}
	...
	function gestioneDPS(dps){
		if (dps == '1') {
			$("#rowW3FS1_DPS_ADD").show();
		} else {
			$("#rowW3FS1_DPS_ADD").hide();
			$("#W3FS1_DPS_ADD").val("");
		}
	}
	...
	function gestioneEAUCTION(eauction){
		if (eauction == '1') {
			$("#rowW3FS1_EAUCTION_INFO").show();
		} else {
			$("#rowW3FS1_EAUCTION_INFO").hide();
			$("#W3FS1_EAUCTION_INFO").val("");
		}
	}
