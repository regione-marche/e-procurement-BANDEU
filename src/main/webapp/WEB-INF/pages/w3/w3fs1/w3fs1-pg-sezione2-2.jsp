...
<gene:formScheda entita="W3FS1" gestisciProtezioni="true"
	...
	<gene:campoScheda entita="W3FS1S2" campo="ID" obbligatorio="true" visibile="false" where="W3FS1.ID = W3FS1S2.ID AND W3FS1S2.NUM = 1"/>
	<gene:campoScheda entita="W3FS1S2" campo="NUM" obbligatorio="true" defaultValue="1" visibile="false" />
	<gene:campoScheda entita="W3ANNEXB" campo="ID" obbligatorio="true" visibile="false" where="W3FS1.ID = W3ANNEXB.ID AND W3ANNEXB.NUM = 1"/>
	<gene:campoScheda entita="W3ANNEXB" campo="NUM" obbligatorio="true" defaultValue="1" visibile="false" />

	<jsp:include page="w3fs1-interno-sezione2-2.jsp">
