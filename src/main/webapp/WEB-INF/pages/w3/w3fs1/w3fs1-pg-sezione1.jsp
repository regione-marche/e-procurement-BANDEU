...
<gene:formScheda entita="W3FS1" gestisciProtezioni="true"
	...
	<gene:campoScheda>
		<td colspan="2"><b>Avviso di preinformazione</b></td>
	</gene:campoScheda>
	<gene:campoScheda entita="W3SIMAP" campo="LEGAL_BASIS" obbligatorio="true" modificabile="false" defaultValue="32014L0024" gestore="it.eldasoft.sil.w3.tags.funzioni.decoratori.campi.GestoreCampoLEGALBASIS"/>	
	<gene:campoScheda campo="NOTICE_F01" obbligatorio="true"/>

	<jsp:include page="/WEB-INF/pages/w3/w3simap/w3simap-pubblication-info.jsp"></jsp:include>	
	
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs1.I")}<br><br></b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>
			${gene:resource("label.simap.fs1.I.1")}
			<br>${gene:resource("label.simap.fs1.I.4")}
			<br>${gene:resource("label.simap.fs1.I.5")}</b>
		</td>
	</gene:campoScheda>
	<gene:archivio titolo="Amministrazione aggiudicatrice"
		...
		<gene:campoScheda visibile="true" modificabile="false" entita="UFFINT" campo="NOMEIN" from="W3AMMI, W3SIMAP, W3SIMAP" where="UFFINT.CODEIN = W3AMMI.CODEIN AND W3AMMI.CODAMM = W3SIMAP.CODAMM AND W3SIMAP.ID = W3FS1.ID" />
	</gene:archivio>
	
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs1.I.2")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs1.I.3")}</b></td>
	</gene:campoScheda>	
	<gene:campoScheda>
	...
	<gene:fnJavaScriptScheda funzione="gestioneNOTICE_F01('#W3FS1_NOTICE_F01#')" elencocampi="W3FS1_NOTICE_F01" esegui="true" />
...
<gene:javaScript>
	...
	$("#W3FS1_NOTICE_F01 option").each(function() {
	...
	function gestioneNOTICE_F01(notice_f01){
		if (notice_f01 == 3) {
			var _messageNoticeF01 = $("<div/>",{"id":"messageNoticeF01"});
			_messageNoticeF01.css("font-style","italic");
			_messageNoticeF01.css("padding-top","5px");
			_messageNoticeF01.text("Gli operatori interessati devono informare l'autorità aggiudicatrice del loro interesse per i contratti d'appalto. I contratti d'appalto saranno aggiudicati senza successiva pubblicazione di un avviso di indizione di gara.");
			$("#W3FS1_NOTICE_F01").parent().append(_messageNoticeF01);
		} else {
			$("#messageNoticeF01").hide();
		}
	}
