...
<gene:template file="popup-template.jsp">
	...
	<gene:redefineInsert name="corpo">
		<form action="${contextPath}/w3/InviaSIMAPWS.do" method="post" name="formInviaSIMAPWS">
			...
			<table class="dettaglio-notab">
				...
				<tr>
					<td colspan="2" class="comandi-dettaglio">
						<INPUT type="button" class="bottone-azione" value="Invia dati a SIMAP" title="Invia dati a SIMAP" onclick="javascript:inviaSIMAPWS();">
	...
	<gene:javaScript>
		...
		function inviaSIMAPWS(){
			if ($("#phase option:selected").val() == "" || $("#phase option:selected").val() == undefined) {
				...
				document.formInviaSIMAPWS.submit();
