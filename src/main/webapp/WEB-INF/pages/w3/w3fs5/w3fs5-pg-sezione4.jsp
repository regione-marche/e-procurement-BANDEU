...
<gene:formScheda entita="W3FS5" gestisciProtezioni="true"
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV")}<br><br></b></td>
	</gene:campoScheda>	
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs5.IV.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs5.IV.1.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="TYPE_PROCEDURE" obbligatorio="true"/>
	<gene:campoScheda campo="ACCELERATED" />
	
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.1.3")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.1.4")}</i></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.1.6")}</i></td>
	</gene:campoScheda>
	<gene:campoScheda campo="IS_ELECTRONIC" />	
	<gene:campoScheda campo="USE_ELECTRONIC" />

	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.1.8")}</i></td>
	</gene:campoScheda>
	<gene:campoScheda campo="GPA" />		
	
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.2")}</i></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs5.IV.2.1")}</i></td>
	</gene:campoScheda>
	<gene:campoScheda campo="NOTICE_NUMBER_OJ" />
		
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.2.2")}</i></td>
	</gene:campoScheda>
	<gene:campoScheda title="Data" campo="RECEIPT_LIMIT_DATE" />
	<gene:campoScheda title="Ora" campo="RECEIPT_LIMIT_TIME" />

	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.2.3")}</i></td>
	</gene:campoScheda>	
	<gene:campoScheda title="Data" campo="DISPATCH_INVITATIONS_DATE" />

	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.2.4")}</i></td>
	</gene:campoScheda>		
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.2.6")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.IV.2.7")}</b></td>
	</gene:campoScheda>	
	...
	<gene:fnJavaScriptScheda funzione="gestioneTYPE_PROCEDURE('#W3FS5_TYPE_PROCEDURE#')" elencocampi="W3FS5_TYPE_PROCEDURE" esegui="true" />	
	<gene:fnJavaScriptScheda funzione="gestioneFRAMEWORK('#W3FS5_FRAMEWORK#')" elencocampi="W3FS5_FRAMEWORK" esegui="true" />
	<gene:fnJavaScriptScheda funzione="gestioneFR_SEVERAL_OP('#W3FS5_FR_SEVERAL_OP#')" elencocampi="W3FS5_FR_SEVERAL_OP" esegui="true" />
	<gene:fnJavaScriptScheda funzione="gestioneDPS('#W3FS5_DPS#')" elencocampi="W3FS5_DPS" esegui="true" />
	<gene:fnJavaScriptScheda funzione="gestioneIS_ELECTRONIC('#W3FS5_IS_ELECTRONIC#')" elencocampi="W3FS5_IS_ELECTRONIC" esegui="true" />
...
<gene:javaScript>
	...
	function gestioneTYPE_PROCEDURE(type_procedure) {
		if (type_procedure == '3' || type_procedure == '5' || type_procedure == '7') {
			$("#rowW3FS5_ACCELERATED").show();					
		} else {
			$("#rowW3FS5_ACCELERATED").hide();
			$("#W3FS5_ACCELERATED").val("");
		}
	}
	...
	function gestioneFRAMEWORK(framework){
		if (framework == '1') {
			$("#rowW3FS5_FR_SEVERAL_OP").show();
			$("#rowW3FS5_FRAME_JUSTIFICATION").show();
		} else {
			$("#rowW3FS5_FR_SEVERAL_OP").hide();
			$("#rowW3FS5_FRAME_OPERATORS_NUMBER").hide();
			$("#rowW3FS5_FRAME_JUSTIFICATION").hide();
			$("#W3FS5_FR_SEVERAL_OP").val("");
			$("#W3FS5_FRAME_OPERATORS_NUMBER").val("");
			$("#W3FS5_FRAME_JUSTIFICATION").val("");
		}
	}
	
	function gestioneFR_SEVERAL_OP(fr_several_op){
		if (fr_several_op == '1') {
			$("#rowW3FS5_FRAME_OPERATORS_NUMBER").show();
		} else {
			$("#rowW3FS5_FRAME_OPERATORS_NUMBER").hide();
			$("#W3FS5_FRAME_OPERATORS_NUMBER").val("");
		}
	...
	function gestioneDPS(dps){
		if (dps == '1') {
			$("#rowW3FS5_DPS_ADD").show();
		} else {
			$("#rowW3FS5_DPS_ADD").hide();
			$("#W3FS5_DPS_ADD").val("");
		}
	}
	...
	function gestioneIS_ELECTRONIC(is_electronic){
		if (is_electronic == '1') {
			$("#rowW3FS5_USE_ELECTRONIC").show();
		} else {
			$("#rowW3FS5_USE_ELECTRONIC").hide();
			$("#W3FS5_USE_ELECTRONIC").val("");
		}
	}
