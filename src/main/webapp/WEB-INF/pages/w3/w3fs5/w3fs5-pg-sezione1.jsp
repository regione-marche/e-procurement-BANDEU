...
<gene:formScheda entita="W3FS5" gestisciProtezioni="true"
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs5.I")}<br><br></b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>
			${gene:resource("label.simap.fs5.I.1")}
			<br>${gene:resource("label.simap.fs5.I.6")}</b>
		</td>
	</gene:campoScheda>
	<gene:archivio titolo="Amministrazione aggiudicatrice"
		...
		<gene:campoScheda visibile="true" modificabile="false" entita="UFFINT" campo="NOMEIN" from="W3AMMI, W3SIMAP, W3SIMAP" where="UFFINT.CODEIN = W3AMMI.CODEIN AND W3AMMI.CODAMM = W3SIMAP.CODAMM AND W3SIMAP.ID = W3FS5.ID" />
	</gene:archivio>
	

	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs5.I.2")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs5.I.3")}</b></td>
	</gene:campoScheda>	
	<gene:campoScheda>
