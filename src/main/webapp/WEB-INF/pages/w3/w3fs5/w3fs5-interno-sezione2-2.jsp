...
<gene:campoScheda>
	<td colspan="2"><b>${gene:resource("label.simap.fs5.II.2")}</b></td>
</gene:campoScheda>	
<gene:campoScheda>
	<td colspan="2"><b>${gene:resource("label.simap.fs5.II.2.1")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.2")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.3")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.4")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="DESCRIPTION" />

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.5")}</b></td>
</gene:campoScheda>		
...
<gene:campoScheda title="Il prezzo non &egrave; il solo criterio di aggiudicazione e tutti i criteri sono indicati solo nei documenti di gara" entita="W3ANNEXB" campo="AC_DOC" />


<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.6")}</b></td>
</gene:campoScheda>	
<gene:campoScheda title="Valore, IVA esclusa" entita="W3ANNEXB" campo="COST" gestore="it.eldasoft.sil.w3.tags.funzioni.decoratori.campi.GestoreCampoMoney"/>

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.7")}</b></td>
</gene:campoScheda>	
...
<gene:campoScheda entita="W3ANNEXB" campo="RENEWAL" />
<gene:campoScheda entita="W3ANNEXB" campo="RENEWAL_DESCR" />

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.9")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="NB_ENV_CANDIDATE" />
<gene:campoScheda entita="W3ANNEXB" campo="NB_MIN_CANDIDATE" />
<gene:campoScheda entita="W3ANNEXB" campo="NB_MAX_CANDIDATE" />
<gene:campoScheda entita="W3ANNEXB" campo="CRITERIA_CANDIDATE" />

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.10")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="ACC_VARIANTS" />

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.11")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="OPTIONS" />
<gene:campoScheda entita="W3ANNEXB" campo="OPTIONS_DESCR" />	

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.12")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="ECATALOGUE_REQUIRED" />

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.13")}</b></td>
</gene:campoScheda>	
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs5.II.2.14")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="ADDITIONAL_INFORMATION" />

<gene:fnJavaScriptScheda funzione="gestioneRENEWAL('#W3ANNEXB_RENEWAL#')" elencocampi="W3ANNEXB_RENEWAL" esegui="true" />
...
<gene:javaScript>
	...
	function gestioneRENEWAL(renewal){
		if (renewal == '1') {
			$("#rowW3ANNEXB_RENEWAL_DESCR").show();
		} else {
			$("#rowW3ANNEXB_RENEWAL_DESCR").hide();
			$("#W3ANNEXB_RENEWAL_DESCR").val("");
		}
	}
