...
<gene:template file="lista-template.jsp" gestisciProtezioni="true" idMaschera="GRP-lista" schema="W3">
	<gene:setString name="titoloMaschera" value="Lista dei gruppi" />
	...
	<gene:redefineInsert name="corpo">
		...
		<table class="lista">
			<tr>
				<td><gene:formLista entita="GRP" pagesize="20" tableclass="datilista" gestisciProtezioni="true" sortColumn="2" gestore="it.eldasoft.sil.w3.tags.gestori.submit.GestoreGRP"> 
					...
					<gene:campoLista title="Id." width="90" campo="IDGRP" href="javascript:chiaveRiga='${chiaveRigaJava}';listaVisualizza();" />	
					<gene:campoLista title="Descrizione" campo="DESCGRP" href="javascript:chiaveRiga='${chiaveRigaJava}';listaVisualizza();"/>
				</gene:formLista></td>
			</tr>
