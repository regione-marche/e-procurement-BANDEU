...
<table class="dettaglio-tab-lista">
	<tr>
		<td><gene:formLista entita="W3FS6AWARD" pagesize="20" sortColumn="4"
			where="W3FS6AWARD.ID = #W3FS6.ID#" tableclass="datilista"
			gestisciProtezioni="true" gestore="it.eldasoft.sil.w3.tags.gestori.submit.GestoreW3FS6AWARD">
			...
			<gene:campoLista entita="W3FS6" campo="ID" where="W3FS6.ID = W3FS6AWARD.ID" visibile="false" />
