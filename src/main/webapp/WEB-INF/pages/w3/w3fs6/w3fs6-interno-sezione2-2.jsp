...
<gene:campoScheda>
	<td colspan="2"><b>${gene:resource("label.simap.fs6.II.2")}</b></td>
</gene:campoScheda>	
<gene:campoScheda>
	<td colspan="2"><b>${gene:resource("label.simap.fs6.II.2.1")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs6.II.2.2")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs6.II.2.3")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs6.II.2.4")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="DESCRIPTION" />

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs6.II.2.5")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="AGREE_TO_PUBLISH" />	
