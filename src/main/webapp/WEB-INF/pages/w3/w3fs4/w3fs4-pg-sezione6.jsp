...
<gene:formScheda entita="W3FS4" gestisciProtezioni="true"
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.VI")}<br><br></b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs4.VI.2")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.VI.3")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="ADDITIONAL_INFORMATION"/>
	
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.VI.4")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs4.VI.4.1")}</b></td>
	</gene:campoScheda>
	<gene:archivio titolo="Ufficio o punto di contatto"
		 lista='${gene:if(gene:checkProt(pageContext, "COLS.MOD.W3.W3FS4.TAX_LEGISLATION_CODEIN"),"gene/uffint/uffint-lista-popup.jsp","")}'
		 ...
		 chiave="W3FS4_REVIEW_BODY_CODEIN">
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.VI.4.2")}</b></td>
	</gene:campoScheda>
	<gene:archivio titolo="Ufficio o punto di contatto"
		 lista='${gene:if(gene:checkProt(pageContext, "COLS.MOD.W3.W3FS4.ENVIRONMENTAL_CODEIN"),"gene/uffint/uffint-lista-popup.jsp","")}'
		 scheda='${gene:if(gene:checkProtObj( pageContext, "MASC.VIS","GENE.SchedaUffint"),"gene/uffint/uffint-scheda.jsp","")}'
		 schedaPopUp='${gene:if(gene:checkProtObj( pageContext, "MASC.VIS","GENE.SchedaUffint"),"gene/uffint/uffint-scheda-popup.jsp","")}'
		 campi="UFFINT.CODEIN;UFFINT.NOMEIN"
		 chiave="W3FS4_MEDIATION_BODY_CODEIN">
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.VI.4.3")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda title="Informazioni dettagliate sui termini di presentazione dei ricorsi" campo="REVIEW_PROCEDURE"/>
	
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.VI.4.4")}</b></td>
	</gene:campoScheda>
	<gene:archivio titolo="Ufficio o punto di contatto"
		 lista='${gene:if(gene:checkProt(pageContext, "COLS.MOD.W3.W3FS4.PROTECTION_CODEIN"),"gene/uffint/uffint-lista-popup.jsp","")}'
		 scheda='${gene:if(gene:checkProtObj( pageContext, "MASC.VIS","GENE.SchedaUffint"),"gene/uffint/uffint-scheda.jsp","")}'
		 schedaPopUp='${gene:if(gene:checkProtObj( pageContext, "MASC.VIS","GENE.SchedaUffint"),"gene/uffint/uffint-scheda-popup.jsp","")}'
		 campi="UFFINT.CODEIN;UFFINT.NOMEIN"
		 chiave="W3FS4_REVIEW_INFO_CODEIN">
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.VI.5")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda entita="V_W3SIMAP" campo="NOTICE_DATE" where="V_W3SIMAP.ID = W3FS4.ID" modificabile="false"/>
