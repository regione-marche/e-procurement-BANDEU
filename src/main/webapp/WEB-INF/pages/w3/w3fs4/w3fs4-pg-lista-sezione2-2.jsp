...
<c:set var="entitaRiferimento" value="W3FS4" scope="session"/>

<table class="dettaglio-tab-lista">
	<tr>
		<td><gene:formLista entita="W3ANNEXB" pagesize="20" sortColumn="4" where="W3ANNEXB.ID = #W3FS4.ID#" tableclass="datilista"
			gestisciProtezioni="true" gestore="it.eldasoft.sil.w3.tags.gestori.submit.GestoreW3ANNEXB" 
			pathScheda="w3/w3fs4/w3fs4-scheda-sezione2-2.jsp">
			...
			<gene:campoLista entita="W3FS4" campo="ID" where="W3FS4.ID = W3ANNEXB.ID" visibile="false" />
		</gene:formLista></td>
	</tr>
	<tr>
