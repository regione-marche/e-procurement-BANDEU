...
<gene:javaScript>
	...
	function gestioneNOTICE_F04(notice_f04){
		if (notice_f04 == 3) {
			...
			_messageNoticeF04.text("Gli operatori interessati devono informare l'ente aggiudicatore del loro interesse per il contratto d'appalto. L'appalto sarà aggiudicato senza pubblicazione di un ulteriore bando di gara.");
