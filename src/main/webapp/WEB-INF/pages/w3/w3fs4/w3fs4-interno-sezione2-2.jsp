...
<gene:campoScheda>
	<td colspan="2"><b>${gene:resource("label.simap.fs4.II.2")}</b></td>
</gene:campoScheda>	
<gene:campoScheda>
	<td colspan="2"><b>${gene:resource("label.simap.fs4.II.2.1")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.2")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.3")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.4")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="DESCRIPTION" obbligatorio="true"/>

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.5")}</b></td>
</gene:campoScheda>	
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.6")}</b></td>
</gene:campoScheda>	
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.7")}</b></td>
</gene:campoScheda>	
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.10")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="ACC_VARIANTS" />

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.11")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="OPTIONS" />
<gene:campoScheda entita="W3ANNEXB" campo="OPTIONS_DESCR" />	

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.13")}</b></td>
</gene:campoScheda>	
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs4.II.2.14")}</b></td>
</gene:campoScheda>	
