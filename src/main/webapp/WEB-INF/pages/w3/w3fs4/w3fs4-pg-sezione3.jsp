...
<gene:formScheda entita="W3FS4" gestisciProtezioni="true"
	gestore="it.eldasoft.sil.w3.tags.gestori.submit.GestoreW3FS4" >
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.III")}<br><br></b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs4.III.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs4.III.1.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="SUITABILITY" />

	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs4.III.1.2")}</b></td>
	</gene:campoScheda>	
	...
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs4.III.1.3")}</b></td>
	</gene:campoScheda>	
	...
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs4.III.1.5")}</b></td>
	</gene:campoScheda>	
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs4.III.2")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs4.III.2.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="PARTICULAR_PROFESSION" />
	<gene:campoScheda campo="REFERENCE_TO_LAW" />
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs4.III.2.2")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="PERFORMANCE_CONDITIONS" />
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs4.III.2.3")}</b></td>
	</gene:campoScheda>
	...
	<gene:fnJavaScriptScheda funzione="gestioneECO_CRITERIA_DOC('#W3FS4_ECO_CRITERIA_DOC#')" elencocampi="W3FS4_ECO_CRITERIA_DOC" esegui="true" />
	<gene:fnJavaScriptScheda funzione="gestioneTECH_CRIT_DOC('#W3FS4_TECH_CRIT_DOC#')" elencocampi="W3FS4_TECH_CRIT_DOC" esegui="true" />
	<gene:fnJavaScriptScheda funzione="gestionePARTICULAR_PROFESSION('#W3FS4_PARTICULAR_PROFESSION#')" elencocampi="W3FS4_PARTICULAR_PROFESSION" esegui="true" />
...
<gene:javaScript>
	...
	function gestioneECO_CRITERIA_DOC(eco_criteria_doc){
		if (eco_criteria_doc == '2') {
			$("#rowW3FS4_ECO_FIN_INFO").show();
			$("#rowW3FS4_ECO_FIN_MIN_LEVEL").show();
		} else {
			$("#rowW3FS4_ECO_FIN_INFO").hide();
			$("#rowW3FS4_ECO_FIN_MIN_LEVEL").hide();
			$("#W3FS4_ECO_FIN_INFO").val("");
			$("#W3FS4_ECO_FIN_MIN_LEVEL").val("");
		}
	}

	function gestioneTECH_CRIT_DOC(tecn_crit_doc){
		if (tecn_crit_doc == '2') {
			$("#rowW3FS4_TECH_PROF_INFO").show();
			$("#rowW3FS4_TECH_PROF_MIN_LEVEL").show();
		} else {
			$("#rowW3FS4_TECH_PROF_INFO").hide();
			$("#rowW3FS4_TECH_PROF_MIN_LEVEL").hide();
			$("#W3FS4_TECH_PROF_INFO").val("");
			$("#W3FS4_TECH_PROF_MIN_LEVEL").val("");
		}
	}

	function gestionePARTICULAR_PROFESSION(particular_profession){
		if (particular_profession == '1') {
			$("#rowW3FS4_REFERENCE_TO_LAW").show();
		} else {
			$("#rowW3FS4_REFERENCE_TO_LAW").hide();
			$("#W3FS4_REFERENCE_TO_LAW").val("");
		}
	}
