...
<c:choose>
	<c:when test='${not empty modo and modo ne "VISUALIZZA" }'>
		<c:set var="modCPV" value="true" scope="request"/>
	</c:when>
	<c:otherwise>
		<c:set var="modCPV" value="false" scope="request"/>
	</c:otherwise>
</c:choose>

<gene:campoScheda>
	<td colspan="2"><b>CPV (Oggetto principale)</b></td>
</gene:campoScheda>	
...
<jsp:include page="/WEB-INF/pages/commons/interno-scheda-multipla.jsp" >
	...
	<jsp:param name="descEntitaVociLink" value="CPV (Oggetto complementare)" />
