...
<gene:formScheda entita="W3FS7" gestisciProtezioni="true"
	...
	<gene:campoScheda>
		<td colspan="2"><b>Sistema di qualificazione</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda title="Il presente avviso &egrave; un avviso di indizione di gara?" campo="QSU_CALL_COMPETITION" />

	<jsp:include page="/WEB-INF/pages/w3/w3simap/w3simap-pubblication-info.jsp"></jsp:include>	
	
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs7.I")}<br><br></b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>
			${gene:resource("label.simap.fs7.I.1")}
			<br>${gene:resource("label.simap.fs7.I.6")}</b>
		</td>
	</gene:campoScheda>
	<gene:archivio titolo="Amministrazione aggiudicatrice"
		...
		<gene:campoScheda visibile="true" modificabile="false" entita="UFFINT" campo="NOMEIN" from="W3AMMI, W3SIMAP, W3SIMAP" where="UFFINT.CODEIN = W3AMMI.CODEIN AND W3AMMI.CODAMM = W3SIMAP.CODAMM AND W3SIMAP.ID = W3FS7.ID" />
	</gene:archivio>
	
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs7.I.2")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs7.I.3")}</b></td>
	</gene:campoScheda>	
	<gene:campoScheda>
