...
<gene:campoScheda>
	<td colspan="2"><b>${gene:resource("label.simap.fs7.II.2")}</b></td>
</gene:campoScheda>	

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs7.II.2.2")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs7.II.2.3")}</b></td>
</gene:campoScheda>
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs7.II.2.4")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="DESCRIPTION" obbligatorio="true"/>

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs7.II.2.5")}</b></td>
</gene:campoScheda>	
...
<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs7.II.2.8")}</b></td>
</gene:campoScheda>	
<gene:campoScheda entita="W3ANNEXB" campo="Q_DATE_START" />
<gene:campoScheda entita="W3ANNEXB" campo="Q_DATE_STOP" />
<gene:campoScheda entita="W3ANNEXB" campo="Q_INDEFINITE" />
<gene:campoScheda entita="W3ANNEXB" campo="Q_RENEWAL" />
<gene:campoScheda entita="W3ANNEXB" campo="Q_RENEWAL_DESCR" />

<gene:campoScheda>
	<td colspan="2"><b><br>${gene:resource("label.simap.fs7.II.2.13")}</b></td>
</gene:campoScheda>	
...
<gene:fnJavaScriptScheda funzione="gestioneQ_RENEWAL('#W3ANNEXB_Q_RENEWAL#')" elencocampi="W3ANNEXB_Q_RENEWAL" esegui="true" />
...
<gene:javaScript>
	...
	function gestioneQ_RENEWAL(renewal){
		if (renewal == '1') {
			$("#rowW3ANNEXB_Q_RENEWAL_DESCR").show();
		} else {
			$("#rowW3ANNEXB_Q_RENEWAL_DESCR").hide();
			$("#W3ANNEXB_Q_RENEWAL_DESCR").val("");
		}
	}
