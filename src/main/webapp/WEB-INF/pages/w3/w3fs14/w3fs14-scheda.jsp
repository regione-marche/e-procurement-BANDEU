...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" idMaschera="W3FS14-scheda" schema="W3">
	...
	<gene:redefineInsert name="corpo">
		<gene:formPagine gestisciProtezioni="true">
			<gene:pagina title="Avviso relativo a informazioni complementari o modifiche" idProtezioni="W3FS14_1">
				<jsp:include page="w3fs14-pg-sezione1-2-6-7.jsp" />
			</gene:pagina>
		</gene:formPagine>
	</gene:redefineInsert>
	...
	<gene:redefineInsert name="addToAzioni" >
		<jsp:include page="/WEB-INF/pages/w3/commons/addtoazioni-simap.jsp" >
			<jsp:param name="formulario" value='W3FS14'/>
		</jsp:include>
	</gene:redefineInsert>
