...
<gene:formScheda entita="W3FS20" gestisciProtezioni="true"
	...
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs20.II.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs20.II.1.1")}</b></td>
	</gene:campoScheda>	
	<gene:campoScheda title="Denominazione" campo="TITLE_CONTRACT" obbligatorio="true"/>
	<gene:campoScheda campo="REFERENCE" />
	
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs20.II.1.2")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs20.II.1.3")}</b></td>
	</gene:campoScheda>
	...
	<gene:fnJavaScriptScheda funzione="gestioneTYPE_CONTRACT('#W3FS20_TYPE_CONTRACT#')" elencocampi="W3FS20_TYPE_CONTRACT" esegui="true" />
...
<gene:javaScript>
	...
	$(window).ready(function (){
		...
		_creaLinkAlberoCpvVP($("#W3FS20_CPV").parent(), "${modo}", $("#W3FS20_CPV"), $("#W3FS20_CPVview") );
		_creaLinkAlberoCpvVSUPP($("#W3FS20_CPVSUPP1").parent(), "${modo}", $("#W3FS20_CPVSUPP1"), $("#W3FS20_CPVSUPP1view") );
		_creaLinkAlberoCpvVSUPP($("#W3FS20_CPVSUPP2").parent(), "${modo}", $("#W3FS20_CPVSUPP2"), $("#W3FS20_CPVSUPP2view") );
