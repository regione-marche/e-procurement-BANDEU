...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" idMaschera="W3FS20-scheda" schema="W3">
	...
	<gene:redefineInsert name="corpo">
		<gene:formPagine gestisciProtezioni="true">
			<gene:pagina title="Sez. I: Amministrazione aggiudicatrice" idProtezioni="W3FS20_1">
				<jsp:include page="w3fs20-pg-sezione1.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. II: Oggetto (II.1)" idProtezioni="W3FS20_2">
				<jsp:include page="w3fs20-pg-sezione2-1.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. II: Oggetto (II.2)" idProtezioni="W3FS20_2_1">
				<jsp:include page="w3fs20-pg-sezione2-2.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. IV: Procedura" idProtezioni="W3FS20_4">
				<jsp:include page="w3fs20-pg-sezione4.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. V: Aggiudicazione dell'appalto" idProtezioni="W3FS20_5_1">
				<jsp:include page="w3fs20-pg-sezione5.jsp" />
			</gene:pagina>				
			<gene:pagina title="Sez. VI: Altre informazioni" idProtezioni="W3FS20_6">
				<jsp:include page="w3fs20-pg-sezione6.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. VII: Modifiche all'appalto" idProtezioni="W3FS20_7">
				<jsp:include page="w3fs20-pg-sezione7.jsp" />
			</gene:pagina>
		</gene:formPagine>
	</gene:redefineInsert>
	...
	<gene:redefineInsert name="addToAzioni" >
		<jsp:include page="/WEB-INF/pages/w3/commons/addtoazioni-simap.jsp" >
			<jsp:param name="formulario" value='W3FS20'/>
		</jsp:include>
	</gene:redefineInsert>
