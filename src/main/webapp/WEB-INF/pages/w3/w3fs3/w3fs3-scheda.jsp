...
<gene:template file="scheda-template.jsp" gestisciProtezioni="true" idMaschera="W3FS3-scheda" schema="W3">
	...
	<gene:redefineInsert name="corpo">
		<c:set var="typeProcedure" value='${gene:callFunction2("it.eldasoft.sil.w3.tags.funzioni.GetTipoProceduraFunction", pageContext, key)}' />
		<c:set var="divIntoLots" value='${gene:callFunction2("it.eldasoft.sil.w3.tags.funzioni.GetDivIntoLotsFS3Function", pageContext, key)}' />
		<gene:formPagine gestisciProtezioni="true">
			<gene:pagina title="Sez. I: Amministrazione aggiudicatrice" idProtezioni="W3FS3_1">
				<jsp:include page="w3fs3-pg-sezione1.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. II: Oggetto (II.1)" idProtezioni="W3FS3_2">
				<jsp:include page="w3fs3-pg-sezione2-1.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. II: Oggetto (II.2)" idProtezioni="W3FS3_2_1" visibile="${divIntoLots ne '1'}">
				<jsp:include page="w3fs3-pg-sezione2-2.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. II: Oggetto (II.2)" idProtezioni="W3FS3_2_2" visibile="${divIntoLots eq '1'}">
				<jsp:include page="w3fs3-pg-lista-sezione2-2.jsp" />
			</gene:pagina>			
			<gene:pagina title="Sez. IV: Procedura" idProtezioni="W3FS3_4">
				<jsp:include page="w3fs3-pg-sezione4.jsp" />
			</gene:pagina>
			<gene:pagina title="Sez. V: Aggiudicazione dell'appalto" idProtezioni="W3FS3_5_1" visibile="${divIntoLots ne '1'}">
				<jsp:include page="w3fs3-pg-sezione5.jsp" />
			</gene:pagina>				
			<gene:pagina title="Sez. V: Aggiudicazione dell'appalto" idProtezioni="W3FS3_5_2" visibile="${divIntoLots eq '1'}">
				<jsp:include page="w3fs3-pg-lista-sezione5.jsp" />
			</gene:pagina>			
			<gene:pagina title="Sez. VI: Altre informazioni" idProtezioni="W3FS3_6">
				<jsp:include page="w3fs3-pg-sezione6.jsp" />
			</gene:pagina>
			<gene:pagina title="Allegato D1" idProtezioni="W3FS3_ANNEXD" selezionabile="${typeProcedure eq '8'}">
				<jsp:include page="w3fs3-pg-annexd.jsp" />
			</gene:pagina>
		</gene:formPagine>
	</gene:redefineInsert>
	...
	<gene:redefineInsert name="addToAzioni" >
		<jsp:include page="/WEB-INF/pages/w3/commons/addtoazioni-simap.jsp" >
			<jsp:param name="formulario" value='W3FS3'/>
		</jsp:include>
	</gene:redefineInsert>
