...
<gene:formScheda entita="W3FS3" gestisciProtezioni="true"
	gestore="it.eldasoft.sil.w3.tags.gestori.submit.GestoreW3SIMAPW3FS3" >

	<gene:campoScheda campo="ID" visibile="false"/>
	<gene:campoScheda entita="W3SIMAP" campo="ID"  where="W3FS3.ID = W3SIMAP.ID" visibile="false"/>
	<gene:campoScheda entita="W3SIMAP" campo="FORM" defaultValue="FS3" visibile="false"/>
	...
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs3.II.1")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>${gene:resource("label.simap.fs3.II.1.1")}</b></td>
	</gene:campoScheda>	
	<gene:campoScheda title="Denominazione" campo="TITLE_CONTRACT" obbligatorio="true"/>
	<gene:campoScheda campo="REFERENCE" />
	
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs3.II.1.2")}</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs3.II.1.3")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="TYPE_CONTRACT" obbligatorio="true"/>

	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs3.II.1.4")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="SHORT_CONTRACT_DESCRIPTION" />

	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs3.II.1.6")}</b></td>
	</gene:campoScheda>
	<gene:campoScheda campo="DIV_INTO_LOTS" />

	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs3.II.1.7")}</b></td>
	</gene:campoScheda>
	...
	<gene:fnJavaScriptScheda funzione="gestioneTYPE_CONTRACT('#W3FS3_TYPE_CONTRACT#')" elencocampi="W3FS3_TYPE_CONTRACT" esegui="true" />
...
<gene:javaScript>
	...
	$(window).ready(function (){
		...
		_creaLinkAlberoCpvVP($("#W3FS3_CPV").parent(), "${modo}", $("#W3FS3_CPV"), $("#W3FS3_CPVview") );
		_creaLinkAlberoCpvVSUPP($("#W3FS3_CPVSUPP1").parent(), "${modo}", $("#W3FS3_CPVSUPP1"), $("#W3FS3_CPVSUPP1view") );
		_creaLinkAlberoCpvVSUPP($("#W3FS3_CPVSUPP2").parent(), "${modo}", $("#W3FS3_CPVSUPP2"), $("#W3FS3_CPVSUPP2view") );
