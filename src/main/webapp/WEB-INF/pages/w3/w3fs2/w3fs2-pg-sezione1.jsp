...
<gene:formScheda entita="W3FS2" gestisciProtezioni="true"
	...
	<gene:campoScheda>
		<td colspan="2"><b>Bando di gara</b></td>
	</gene:campoScheda>
	...
	<gene:campoScheda>
		<td colspan="2"><b><br>${gene:resource("label.simap.fs2.I")}<br><br></b></td>
	</gene:campoScheda>
	<gene:campoScheda>
		<td colspan="2"><b>
			${gene:resource("label.simap.fs2.I.1")}
			<br>${gene:resource("label.simap.fs2.I.4")}
			<br>${gene:resource("label.simap.fs2.I.5")}</b>
		</td>
	</gene:campoScheda>
	<gene:archivio titolo="Amministrazione aggiudicatrice"
		...
		<gene:campoScheda visibile="true" modificabile="false" entita="UFFINT" campo="NOMEIN" from="W3AMMI, W3SIMAP, W3SIMAP" where="UFFINT.CODEIN = W3AMMI.CODEIN AND W3AMMI.CODAMM = W3SIMAP.CODAMM AND W3SIMAP.ID = W3FS2.ID" />
	</gene:archivio>
	...
	<gene:campoScheda>
		<td colspan="2"><br><b>${gene:resource("label.simap.fs2.I.3")}</b></td>
	</gene:campoScheda>	
	<gene:campoScheda>
